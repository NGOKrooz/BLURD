...
/**
 * Setup script for country proof circuit
...
const circuitName = 'countryProof';
...
console.log('🔨 Setting up country proof circuit...\n');
...
const filesToCopy = [
  { src: wasmFile, dest: path.join(publicDir, `${circuitName}.wasm`) },
  { src: zkeyFile, dest: path.join(publicDir, `${circuitName}.zkey`) },
  { src: vkeyFile, dest: path.join(publicDir, `${circuitName}_verification_key.json`) },
];
